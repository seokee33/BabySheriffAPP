...
import com.sheriffs.babysheriff.view.main.Menu_diary;
...
public class CalendarAdapter extends RecyclerView.Adapter<CalendarAdapter.CustomViewHolder> {
    ...
    private Menu_diary menu_diary;

    private ArrayList<EventInfo> mEventInfos;

    public CalendarAdapter(Fragment _context,Menu_diary menu_diary) {
        this.mContext = _context;
        this.mDBHelper = new DBHelper(_context.getContext());
        this.mBaseCalendar = new BaseCalendar();
        this.mEventInfos = mDBHelper.getSelectEventListDB();
        this.menu_diary = menu_diary;
    ...
    public CalendarAdapter.CustomViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View holder = LayoutInflater.from(mContext.getContext()).inflate(R.layout.list_item_schedule,parent, false);
        ...
        public CustomViewHolder(@NonNull View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Toast.makeText(mContext.getContext(), strCombineDate, Toast.LENGTH_SHORT).show();
    ...
    private void setEditEventDialog(String _combineDate, ArrayList<EventInfo> _item)
    {
        ...
        // 팝업 창 띄우기
        Dialog dialog = new Dialog(mContext.getContext());
        ...
        btn_ok.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View view)
            {
                if(et_title.getText().length() == 0 || et_content.getText().length() == 0) {
                    Toast.makeText(mContext.getContext(), "입력필드가 비어있습니다.", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                if( !mIsAlreadyWrited ) {
                    ...
                    Toast.makeText(mContext.getContext(), "이벤트 목록에 추가 되었습니다 !", Toast.LENGTH_SHORT).show();
                } else {
                    ...
                    Toast.makeText(mContext.getContext(), "이벤트 목록이 수정 되었습니다 !", Toast.LENGTH_SHORT).show();
                }
                notifyDataSetChanged();
                ((Menu_diary)mContext).diaryListSetInit();
                dialog.dismiss();
            }
        });
        ...
        btn_delete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(mContext.getContext(), "이벤트 목록이 삭제 되었습니다 !", Toast.LENGTH_SHORT).show();
                notifyDataSetChanged();
                dialog.dismiss();
            }
        });
    ...
    private void refreshView(Calendar _calendar) {
        notifyDataSetChanged();
        ((Menu_diary)mContext).refreshCurrentMonth(_calendar);
