package com.sheriffs.babysheriff.database;
...
public class DBHelper extends SQLiteOpenHelper
{
    ...
    private static final String DB_NAME = "babysheriff.db";
    ...
    public ArrayList<EventInfo> getSelectedLikeEventItem(String _writeDate) {
        ArrayList<EventInfo> eventInfos = new ArrayList<>();
        SQLiteDatabase db = getReadableDatabase();
        String sql = "SELECT * FROM EventList WHERE writeDate Like '%"+ _writeDate +"%'";
        //Log.i("sqlValue",sql);
